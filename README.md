...
- [x] PHP-FPM: `php:8.4.19-fpm-alpine3.22` -> GLPI PHP: `eftechcombr/glpi:php-fpm-11.0.9`
- [x] Nginx: `nginxinc/nginx-unprivileged:1.27.5-alpine3.21-slim` -> GLPI Nginx: `eftechcombr/glpi:nginx-11.0.9`
