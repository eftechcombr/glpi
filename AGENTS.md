...
docker build -t eftechcombr/glpi:php-fpm-12.0.0-rc2 -f docker/php/Dockerfile docker/php/
docker build -t eftechcombr/glpi:nginx-12.0.0-rc2 -f docker/nginx/Dockerfile docker/nginx/
```
