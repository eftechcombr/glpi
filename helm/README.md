...
| Parameter | Description | Default |
|-----------|-------------|---------|
| `glpi.version` | GLPI version to deploy | `"12.0.0-rc2"` |
...
| `glpi.phpfpm.image.tag` | PHP-FPM image tag | `php-fpm-12.0.0-rc2` |
...
| `glpi.nginx.image.tag` | Nginx image tag | `nginx-12.0.0-rc2` |
